...
"""
All Playables are played from outside
All Drawables are my documentationn is lacking
drawables include all planets ships and planets and stars etc
"""
...
def init():
    ...
    pygame.mixer.music.load('_game_music.ogg')
